...
# CIL CONFIG
NOTE="ewc_pre_trained_wo_cutmix_with_neck_disjoint_cifar10_mem500_iter_1_collapse_check" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ewc"
K_COEFF="4"
TEMPERATURE="0.125"
...
do
    CUDA_VISIBLE_DEVICES=4 nohup python main_new.py --mode $MODE \
